...
public abstract class BaseEditActivityWrapper_Roo_Gwt implements Activity, IsScaffoldMobileActivity {
    ...
    public interface View_Roo_Gwt<V extends org.prodageo.exa6023.client.scaffold.place.ProxyEditView<org.prodageo.exa6023.client.managed.request.BaseProxy, V>> extends ProxyEditView<BaseProxy, V> {
    }
}
