...
import fr.insarouen.prof.shared.FieldVerifier;
 ...
 */
public class Carnet implements EntryPoint {
  /**
  ...
  public void onModuleLoad() {
    ...
    dialogVPanel.add(new HTML("<b>Code postal envoyé au serveur:</b>"));
    dialogVPanel.add(textToServerLabel);
    dialogVPanel.add(new HTML("<br><b>Département retourné par le serveur:</b>"));
