...
public class CalculatriceMemoireTest {
 ...
 try
 {
        ...
        Logger logger = Logger.getLogger(CalculatriceMemoireTest.class.getName());

    CalculatriceRemote calc1 = (CalculatriceRemote) ctx.lookup("java:global/classes/CalculatriceMemoireBean!org.prodageo.equipe.CalculatriceRemote");
    // Object ref = ctx.lookup("java:global/classes/CalculatriceMemoireBean!org.prodageo.equipe.CalculatriceRemote");
    ...
    assertNotNull(calc1);
        ...
        assertEquals(3, expResult );
            ...
            CalculatriceRemote calc2 = (CalculatriceRemote) ctx.lookup("java:global/classes/CalculatriceMemoireBean!org.prodageo.equipe.CalculatriceRemote");
            ...
            // dereference calc1
            calc1 = (CalculatriceRemote) ctx.lookup("java:global/classes/CalculatriceMemoireBean!org.prodageo.equipe.CalculatriceRemote");
	    ...
	    try {            
            ...
            CalculatriceRemote calc3 = (CalculatriceRemote) ctx.lookup("java:global/classes/CalculatriceMemoireBean!org.prodageo.equipe.CalculatriceRemote");
            ...
            CalculatriceRemote calc4 = (CalculatriceRemote) ctx.lookup("java:global/classes/CalculatriceMemoireBean!org.prodageo.equipe.CalculatriceRemote");
