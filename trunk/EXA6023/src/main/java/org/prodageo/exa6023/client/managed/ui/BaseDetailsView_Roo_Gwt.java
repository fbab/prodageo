...
public abstract class BaseDetailsView_Roo_Gwt extends Composite implements ProxyDetailsView<BaseProxy> {
    ...
    public void setValue(BaseProxy proxy) {
        ...
        displayRenderer.setInnerText(BaseProxyRenderer.instance().render(proxy));
    }
}
