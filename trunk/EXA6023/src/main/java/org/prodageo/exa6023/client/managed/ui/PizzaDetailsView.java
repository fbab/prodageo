...
import org.prodageo.exa6023.client.managed.ui.PizzaDetailsView.Binder;
...
public class PizzaDetailsView extends PizzaDetailsView_Roo_Gwt {

    private static final Binder BINDER = GWT.create(Binder.class);

    private static org.prodageo.exa6023.client.managed.ui.PizzaDetailsView instance;
    ...
    public static org.prodageo.exa6023.client.managed.ui.PizzaDetailsView instance() {
        if (instance == null) {
            instance = new PizzaDetailsView();
        }
        return instance;
    }
    ...
    interface Binder extends UiBinder<HTMLPanel, PizzaDetailsView> {
    }
}
