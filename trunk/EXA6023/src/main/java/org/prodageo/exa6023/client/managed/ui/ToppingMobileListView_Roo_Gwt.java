...
public abstract class ToppingMobileListView_Roo_Gwt extends MobileProxyListView<ToppingProxy> {

    protected Set<String> paths = new HashSet<String>();

    public ToppingMobileListView_Roo_Gwt(String buttonText, SafeHtmlRenderer<org.prodageo.exa6023.client.managed.request.ToppingProxy> renderer) {
