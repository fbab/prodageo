...
abstract class BaseVille extends BaseObject  implements Persistent {
	...
	public function setListville($v)
	{
		...
		if ($this->listville !== $v) {
			$this->listville = $v;
			$this->modifiedColumns[] = VillePeer::LISTVILLE;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			$this->listville = $rs->getString($startcol + 1);
	...
	protected function doSave($con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			$this->alreadyInSave = true;
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = VillePeer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setId($pk);  
					$this->setNew(false);
				} else {
					$affectedRows += VillePeer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[1], $arr)) $this->setListville($arr[$keys[1]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(VillePeer::LISTVILLE)) $criteria->add(VillePeer::LISTVILLE, $this->listville);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setListville($this->listville);
