...
<a href="<?php echo url_for('nomfjt/index') ?>">nom FJT</a><br/>
<a href="<?php echo url_for('nomlocapass/index') ?>">nom Loca-pass</a><br/>
<a href="<?php echo url_for('tranchesalaire/index') ?>">tranche salaire</a><br/>
<a href="<?php echo url_for('typecontrat/index') ?>">typecontrat</a><br/>
<a href="<?php echo url_for('typelogement/index') ?>">typelogement</a><br/>
<a href="<?php echo url_for('typeparc/index') ?>">typeparc</a><br/>
<a href="<?php echo url_for('typeproprietairehebtemp/index') ?>">typeproprietairehebtemp</a><br/>
